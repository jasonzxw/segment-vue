...
var npyjs = class {
  ...
  parse(arrayBufferContents) {
    ...
    const header = JSON.parse(
      hcontents.toLowerCase().replace(/'/g, '"').replace("(", "[").replace(/,*\),*/g, "]")
    );
  ...
  async load(filename, callback, fetchArgs) {
    ...
    if (filename instanceof ArrayBuffer) {
      ...
      const resp = await (0, import_cross_fetch.default)(filename, { ...fetchArgs });
...
var npyjs_default = npyjs;
export {
  npyjs_default as default
};
